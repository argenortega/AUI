...
#
# Created: Sat Feb 28 01:38:26 2015
...
class Ui_AUIParameters(object):
    def setupUi(self, AUIParameters):
        ...
        AUIParameters.setMinimumSize(QtCore.QSize(250, 539))
        ...
        self.contents.setMaximumSize(QtCore.QSize(250, 16777215))
        ...
        self.episodes.setMaximumSize(QtCore.QSize(250, 16777215))
        ...
        self.userStatus.setMaximumSize(QtCore.QSize(250, 16777215))
        ...
        self.taskContext.setMaximumSize(QtCore.QSize(250, 16777215))
        ...
        self.robotStatus.setMaximumSize(QtCore.QSize(250, 16777215))
    ...
    def retranslateUi(self, AUIParameters):
        ...
        self.contents.setTabText(self.contents.indexOf(self.Tab1), _translate("AUIParameters", "Tab 1", None))
